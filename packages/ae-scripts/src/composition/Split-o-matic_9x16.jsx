/**
 * Split-o-matic 9x16 - Vertical Split Screen Template Generator for Adobe After Effects
 *
 * Creates professional 9:16 vertical split-screen compositions for mobile/social media content.
 * Automatically generates multi-screen layouts optimized for Instagram Stories, TikTok, and other 
 * vertical formats with organized folder structure and template system.
 *
 ...
 * 
 * @description
 * Split-o-matic 9x16 generates a comprehensive vertical split-screen template system for
 * creating engaging mobile and social media content. The script creates organized folder
 * structures and multiple composition templates that enable easy creation of side-by-side
 * or multi-panel content layouts optimized for vertical viewing platforms.
 * 
 * @functionality
 * • Creates organized "9x16 Template" folder structure for project management
 * • Generates multiple split-screen composition templates
 * • Sets up vertical aspect ratio optimized for mobile platforms
 * • Creates reusable template system for consistent branding
 * • Organizes assets with proper naming conventions
 * • Configures compositions for social media specifications
 * 
 * @usage
 * 1. Select an existing composition in your project
 * 2. Run the script - no user interface required
 * 3. Script creates "9x16 Template" folder with organized compositions
 * 4. Access the generated split-screen templates from the project panel
 * 5. Duplicate and customize templates for your specific content
 * 6. Add your media assets to the template compositions
 * 
 * @requirements
 * • Adobe After Effects CS6 or later
 * • An existing composition must be selected in the project panel
 * • Sufficient memory for multiple composition creation
 * 
 * @notes
 * • Templates are optimized for 9:16 aspect ratio (mobile/social media)
 * • Folder system helps organize complex social media projects
 * • Templates can be duplicated and modified for different layouts
...
try {
	app.beginUndoGroup("Split-o-matic 9x16");
