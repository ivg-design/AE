 ...
 * 
 * @description
 * A sophisticated shape conversion system that transforms parametric rectangles into fully
 * controllable bezier paths with advanced corner rounding capabilities. This tool provides
 * individual corner control, dynamic anchor point positioning, and expression-based animation
 * support, making it essential for creating complex geometric animations and responsive
 * interface elements in After Effects.
 * 
 * @functionality
 ...
 * • The system is fully compatible with shape layer parenting and pre-compositions
