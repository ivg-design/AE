...
var MainUI = (function () {
    ...
    module.show = function (thisObj) {
        ...
        //ONCLICK FUNCTIONS
            ...
            tuneSyncButton.onClick = function () {
                ...
                switch (propertyType) {
                    case '2D':
                        XYUnifyDialog(layer, propName, audioReactorName, propMatchName);
                        break;
                    case '3D':
                        XYZUnifyDialog(layer, propName, audioReactorName, propMatchName)
                        break;
                    case 'Color':
                        handleColorProperty(layer, propName, audioReactorName, propMatchName); 
                        break;
                    case '1D':
                    default:
                        handle1DProperty(layer, propName, audioReactorName, propMatchName);
                        break;
                }
                app.endUndoGroup();
            };
    ...
    //DIALOGS
        //2D DIALOG
             ...
             */
            function XYUnifyDialog(layer, propName, audioReactorName, propMatchName) {
                //LAYOUT
                ...
                //ON CLICK FUNCTIONS
                    buttonGroup.add('button', undefined, 'OK').onClick = function () {
                        handle2DProperty(layer, xCheckBox.value, yCheckBox.value, unifiedCheckBox.value, propName, audioReactorName, propMatchName);
                        dialog.close();
                    };
    ...
    //HANDLERS
        ...
        //1D HANDLER
             ...
             * @returns {void}
             */
            function handle1DProperty(layer, propName, audioReactorName, propMatchName) {
                // Create Easing dropdown
                var dropDownParams = ["Linear", "EaseIn", "EaseOut", "EaseInOut"];
                var easingDropdown = layer.Effects.addProperty("ADBE Dropdown Control");
                var setDropDownParams = easingDropdown.property(1).setPropertyParameters(dropDownParams);
        ...
        //2D HANDLER
             ...
             * @returns {void}
            */
            function handle2DProperty(layer, xSelected, ySelected, isUnified, propName, audioReactorName, propMatchName) {
