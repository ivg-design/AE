/**
 * It Follows Script: Animate a Selected Position Property Along a Shape Path in Adobe After Effects
 *
 ...
 * - 1.2.0: Removed auto-parenting functionality; the expression now supports both parented and unparented layers equally.
 * - 1.3.0:
 *   • Added partial path segments by percentage (e.g., "Segment 20 - 75%").
 *   • Introduced "Reverse Direction" checkbox in the expression.
 *   • Recognizes "Loop" and "Ping-Pong" keywords in the marker comment.
 *   • Uses double pipes (`||`) to separate Easing, Segment, and Loop/Ping-Pong in the marker comment.
 *   • Defaults to linear easing (0,0,1,1) and a 0–100% segment if marker is absent or invalid.
 *
 * @license MIT
 */

(function applyPathExpression() {
	app.beginUndoGroup("it_follows");
