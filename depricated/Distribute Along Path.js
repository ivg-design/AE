...
var expression = 'function calcPathLength(path) {' + '\n' +
	'  var length = 0;' + '\n' +
	'  var numPoints = path.points().length;' + '\n' +
	'  for (var i = 1; i < numPoints; i++) {' + '\n' +
	'    length += lengthTo(path.points()[i - 1], path.points()[i]);' + '\n' +
	'  }' + '\n' +
	'  return length;' + '\n' +
	'}' + '\n' +
	...
	'var path = selectedPathLayer.mask("Mask 1").maskPath;' + '\n' +
	...
	'var pos = path.pointOnPath(t / pathLength, true);' + '\n' +
	'var tangent = path.normalOnPath(t / pathLength, true);' + '\n' +
